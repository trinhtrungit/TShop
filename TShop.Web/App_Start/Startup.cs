...
namespace TShop.Web.App_Start
{
    public partial class Startup
    {
        ...
        private void ConfigAutofac(IAppBuilder app)
        {
            ...
            builder.RegisterApiControllers(Assembly.GetExecutingAssembly()); // register for web api
            builder.RegisterControllers(Assembly.GetExecutingAssembly()); // register for web mvc
